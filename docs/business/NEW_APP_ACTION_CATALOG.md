...
| NEW-ACT-PROF-07 | NEW-PROF-SHEET-001 | modal_action: Подтвердить выход | Confirm logout | /legacy/home?guest=1 | MVP |
| NEW-ACT-PROF-08 | NEW-PROF-003 | picker: PIN keypad digits | Enter new PIN twice | /legacy/profile | MVP |
| NEW-ACT-AUTH-01 | NEW-AUTH-003 | submit: Continue phone/IIN | Submit identifier to start auth | NEW-AUTH-004|NEW-AUTH-011 | MVP |
